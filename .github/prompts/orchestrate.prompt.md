...
description: "Run the full orchestration pipeline for a GitHub issue — full pipeline: scope classification, smart resume, D9 checkpoint, implementation, review, PR"
