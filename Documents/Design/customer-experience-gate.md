...
| D4 | Visual Verification Gate | **Remove entirely.** CE Gate at end-of-PR replaces it. | CE Gate subsumes Visual Gate's purpose; per-step regression handled by automated tests (Tier 1, Validation Ladder); one concept instead of two |
